...
class Logger {
    ...
    def static error(Object msg) {
        try {
            println("${LogUI.C_ERROR.value}[NewAutoTrack]: ${msg}${LogUI.E_NORMAL.value}")
        } catch (Exception e) {
            e.printStackTrace()
        }
    }
    ...
    def static warn(Object msg) {
        try {
            println("${LogUI.C_WARN.value}[NewAutoTrack]: ${msg}${LogUI.E_NORMAL.value}")
        } catch (Exception e) {
            e.printStackTrace()
        }
    }
